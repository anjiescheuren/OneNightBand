$(function() {
  ...
  $.ajax({
    ...
    .done(function(data) {
      ...
      function formatShowObj(shows, event, i) {
          return {
      ...
      function likeShow() {
        ...
        if (venue.time === "Invalid date") {
          $('.itineraryList').append('<li class="event" data-eventId="' + eventIndex + '" id="event-' + eventIndex + '"><div class="showArtist">' + venue.artist + '</div><div class="listItem"> at ' + venue.venue + '</div><div class="listItem">' + venue.date + '</div><div class="listItem"> TBA </div><a href="" class="delete">Remove</a></li>');
          $('.delete').click(function(e) {
            e.preventDefault();
            $('.event#event-' + eventIndex).html('');
          })
        }
        if (venue.time != "Invalid date") {
          $('.itineraryList').append('<li class="event" data-eventId="' + eventIndex + '" id="event-' + eventIndex + '"><div class="showArtist">' + venue.artist + '</div><div class="listItem"> at ' + venue.venue + '</div><div class="listItem">' + venue.date + '</div><div class="listItem">' + venue.time + '</div><a href="" class="delete">Remove</a></li>');
          $('.delete').click(function(e) {
            e.preventDefault();
            $('.event#event-' + eventIndex).html('');
          })
